...
def find_mxl(bs_file):
    """
    Function to find the MXL file from an HTML page. 
    Retruns a dictionary with the link to the MXL file, 
    the name of the publisher, with URL of the publisher, the associated liscence and the format. 
    """
