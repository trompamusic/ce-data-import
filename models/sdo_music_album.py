"""The schema.org MusicAlbum model.

For reference see schema.org: https://schema.org/MusicAlbum
"""
...
class MusicAlbum(MusicPlaylist):
    ...
    Attributes derived from MusicPlaylist
    ------------------------------------
    numTracks
        Integer
        The number of tracks in this album or playlist.
    track
        ItemList or MusicRecording
        A music recording (track)—usually a single song. If an ItemList is
        given, the list should contain items of type MusicRecording. Supersedes
        tracks.
