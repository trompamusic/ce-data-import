"""The schema.org CreativeWork model.

For reference see schema.org: https://schema.org/CreativeWork
"""
...
class CreativeWork(Thing):
    ...
    accountablePerson = None
    aggregateRating = None
    alternativeHeadline: str = None
    ...
    dateModified = None
    datePublished = None
    discussionUrl: str = None
    editor = None
    educationalAlignment = None
    educationalUse: str = None
    encoding = None
    exampleOfWork = None
    fileFormat = None
    funder = None
